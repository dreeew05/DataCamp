# 🧩 DataCamp Accomplishment — Associate Data Analyst in SQL

## 🧾 Overview

I am proud to share that I have successfully completed the **Associate Data Analyst in SQL** career track on [DataCamp](https://www.datacamp.com/)!  
This program provided hands-on training in writing efficient SQL queries, analyzing and transforming data, and communicating insights effectively using **PostgreSQL** and real-world data.

---

## 🏆 Certificate of Accomplishment

![Certificate](./Certificates/Associate%20Data%20Analyst%20in%20SQL%20[Image].png)

🎓 **Verify this certificate:**  
👉 [**View on DataCamp**](https://www.datacamp.com/completed/statement-of-accomplishment/track/dfcb2589630642c47a1a4a9c7f7e4fa54348ee71) 

---

## 🪪 Badge

![Badge](./Certificates/Associate%20Data%20Analyst%20in%20SQL%20Badge.png)

*Awarded for completing all courses and assessments in the Associate Data Analyst in SQL track.*

---

## 📘 About the Track

The **Associate Data Analyst in SQL** career track equips learners with the technical skills to extract, manipulate, and analyze data using SQL.  
Throughout the track, I gained experience in querying databases, joining and aggregating data, performing exploratory analysis, and communicating findings to drive data-driven decisions.
...
- Data Visualization and Communication Principles  

---

## 💬 About DataCamp

[DataCamp](https://www.datacamp.com) is a global online learning platform offering interactive courses in data science, analytics, and AI.  
The **Associate Data Analyst in SQL** career track provides guided, hands-on learning through exercises, projects, and assessments led by industry experts.
